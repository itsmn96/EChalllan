...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <!--<li class="nav-item">
                <a class="nav-link" href="leave_history.php" style="color:white;">Complaint History</a>
            </li>-->
                                         ...
                                         $cnt=1;
                                          ...
                                          while($row = mysqli_fetch_assoc($query)){
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td><a href=\"compupdate.php?chno={$row['chno']}&selection=Accept\"><button class='btn-success btn-sm' >Accept</button></a>
                                                    <a href=\"compupdate.php?chno={$row['chno']}&selection=Reject\"><button class='btn-danger btn-sm' >Reject</button></a></td>
                                                  </tr>";  
                                         $cnt++; }       
                                    }
                                }
